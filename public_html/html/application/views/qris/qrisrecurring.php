        ...
        <div class="card-body">
            <div class="row">
                ...
                <?php if ($this->session->flashdata('success')) : ?>
                    ...
                    <form id="mutation_form" method="post" action="<?php echo base_url('admin/qris_recurring'); ?>">
                        <div class="row mb-4"> 
                            <div class="col-md-12"> 
                        ...
                        <div class="row mb-4"> 
                            ...
                            <div class="col-md-6"> 
                                <a href="<?php echo base_url('admin/resetqris_recurring'); ?>" type="button" name="reset" class="btn btn-warning">Reset</a>
                            </div>
                            <!-- <div class="col-md-4"> 
                                <?php
                                    $download_url = base_url('admin/download_qris_recurring') . "?search_date=" . $search_date_value;
                                ?>
        ...
        <div class="card-body">       
            <div class="table-responsive">
                <table class="table table-hover" style="margin-top:20px;">
                    ...
                    <tbody>
                    <?php if (empty($qrisrecurrings)): ?>
                        <tr>
                            <td colspan="6" align="center">No data in display</td>
                        </tr>
                    <?php else: ?>
                    <?php foreach ($qrisrecurrings as $mutation): ?>
                        <tr>
