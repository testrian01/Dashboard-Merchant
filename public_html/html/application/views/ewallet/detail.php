...
<div class="container-fluid">
    <div class="card shadow border-left-info">
        <div class="card-header">
            <h3>Detail Deposit Ewallet</h3>
        </div>
        <div class="card-body">
            <table style="width:100%">
                <tbody>
                    <?php foreach ($detail_ewallet as $data): ?>
                    <tr>
                        <td>Channel</td>
                    ...
                    <tr>
                        <td>Phone Number</td>
                        <td>: <?php echo $data['c_phoneNumber']; ?></td>
                    </tr>
                    <tr>
                        <td>Nominal</td>
                    ...
                    <tr>
                        <td>Ewallet Link</td>
                        <td>: <?php if(!empty($data['c_ewalletLink'])) { ?> <a href="<?php echo $data['c_ewalletLink']; ?>" target="blank">Buka Link</a> <?php } ?> </td>
                    </tr>   
                    <tr>
