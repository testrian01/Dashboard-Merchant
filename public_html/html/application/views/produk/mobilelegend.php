                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form id="purchaseForm<?= $row->id; ?>" method="post" action="<?= base_url('admin/purchase_token/' . $row->id); ?>">
                                <div class="mb-3">
                                    <label for="mobilelegend" class="form-label">Produk</label>
                                    <input type="tel" class="form-control" id="mobilelegend<?= $row->id; ?>" name="token_pln" value="<?= $row->id; ?>" readonly>
                                    <input type="hidden" name="name" value="mobilelegend">
                                </div>
                                <div class="mb-3">
                                    <label for="id_game" class="form-label">ID Game</label>
                                    <input type="tel" class="form-control" id="id_game<?= $row->id; ?>" name="id_game" required>
                                </div>
